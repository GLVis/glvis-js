...
The web version of GLVis supports virtually all features of the desktop client, including key commands, mouse interactions, socket connections, and adds touch support for mobile devices.
...
of the desktop version and can be used as an alternative to `./glvis -m mesh -g gf`.
...
Follow your browser's instructions, press the fullscreen button, or use the `esc` key to exit.
